...
def main():
    ...
    PATCH_SIZE = 512
    output_folder = "/home/fabian/PycharmProjects/Recipes/examples/UNet/adam/"
    ...
    class_weights = class_frequencies[[1,0]]**0.7
    ...
    while epoch < N_EPOCHS:
        ...
        if (epoch != 0) and (np.mean(losses_val) > 1.3 * val_loss_old):
            ...
            plot_learning_curve(all_training_accs, all_training_losses, all_validation_accs, all_validation_losses, output_folder + "road_segm_adam_learn_curve.png")
